...
(function() {
  $(document).on('turbolinks:load', function() {
    ...
    $(document).on('click', '.voteable', function() {
      var $that, name, restaurantId, roundId;
      $that = $(this);
      ...
      return $.ajax({
        ...
        success: function() {
          return $that.removeClass('voteable').addClass('voted');
        }
      });
    });
    ...
    $("#vote-finish").click(function(e) {
      ...
      return $.ajax({
        ...
        success: function() {
          ...
          return $("#vote-finish").removeClass('hvr-grow-shadow').css('background-color', 'green');
        }
      });
    });
    ...
    return $("#radius").change(function() {
      $("#direction").animate({
        ...
        return $("#create-button").css('border', 'solid 2px #41A005').removeClass("dim");
      });
      return $("#radius-div").css('border', 'solid 1px black').addClass("dim");
    });
  });
